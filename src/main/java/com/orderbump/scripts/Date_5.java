...
public class Date_5 extends BaseLib
{
	@Test
	public void isEqualTo_1()
	{
		...
		rp.selectRuleType("date");
		rp.selectOperator("==");
		rp.applyConditionValue("2019-09-12");
	...
	public void isGreaterThan_ValidCase_3()
	{
		...
		rp.selectRuleType("date");
		rp.selectOperator(">");
		rp.applyConditionValue("2019-09-11");
		rp.clickOnSaveRulesBtn();
	...
	public void isGreaterThan_InvalidCase_4()
	{
		...
		rp.selectRuleType("date");
		rp.selectOperator(">");
		rp.applyConditionValue("2022-09-11");
		rp.clickOnSaveRulesBtn();
	...
	public void isLessThan_ValidCase_5()
	{
		...
		rp.selectRuleType("date");
		rp.selectOperator("<");
		rp.applyConditionValue("2022-09-12");
		rp.clickOnSaveRulesBtn();
